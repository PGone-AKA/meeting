<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="场景表述" prop="sceneDesc">
        <el-input
    ...
    <el-table v-loading="loading" :data="sceneList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="场景表述" align="center" prop="sceneDesc" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="场景表述" prop="sceneDesc">
          <el-input v-model="form.sceneDesc" placeholder="请输入场景表述" />
        </el-form-item>
      </el-form>
...
<script>
import { listScene, getScene, delScene, addScene, updateScene } from "@/api/yjy/scene";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除场景签到编号为"' + sceneIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('yjy/scene/export', {
        ...this.queryParams
